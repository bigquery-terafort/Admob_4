"""
AdMob → BigQuery  (PRODUCTION v4) — Account 4 — pub-9688592152492531
==========================================================
THIS REPO HANDLES: Account 4 (pub-9688592152492531)
Writes into the SHARED dataset `Admob` alongside Accounts 1-3,
isolated by publisher_id (publisher-scoped DELETEs never touch other accounts).
...
REQUIRED ENV VARS:
   ADMOB_PUBLISHER_ID    = pub-9688592152492531   (or accounts/pub-9688592152492531)
   GCP_PROJECT_ID        = terafort
   BQ_DATASET_ID         = Admob   (SHARED with Accounts 1-3)
   BQ_LOCATION           = US (default)
   OAUTH_CLIENT_ID       = <OAuth client for Account 4's AdMob account>
   OAUTH_CLIENT_SECRET   = <OAuth secret>
   OAUTH_REFRESH_TOKEN   = <Refresh token specific to Account 4>
   GCP_CREDENTIALS_JSON  = <Service account JSON>

USAGE:
   python admob_full_sync.py --days 3
   python admob_full_sync.py --backfill-start 2026-04-30 --backfill-end 2026-05-19
